    ...
    <div className="min-h-screen flex bg-bgWarm">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-[#141A17] text-neutral-300 shrink-0 fixed inset-y-0 z-30 border-r border-neutral-800">
        ...
        <div className="px-4 py-3 border-b border-neutral-800 bg-neutral-900/50 flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-brand-700 text-white font-bold flex items-center justify-center text-xs shrink-0">
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b border-borderSubtle sticky top-0 z-20 px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-[11px] font-bold bg-brand-50 text-brand-700 border border-brand-200 px-2.5 py-1 rounded-full uppercase tracking-wider">
              {adminUser.role.replace(/_/g, " ")}
            </span>
          </div>
        </header>
