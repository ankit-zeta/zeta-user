...
export default function AffiliateGuidelinesPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
      <div className="space-y-2 border-b border-borderSubtle pb-6">
        <h1 className="text-3xl font-bold tracking-tight text-textMain">Referral Program Guidelines</h1>
      ...
      <div className="prose prose-sm max-w-none text-textMuted space-y-8 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-2 text-textMuted">
            <li><strong>Purchase-based:</strong> A commission is credited when a new customer completes a genuine purchase of a program through your unique link and receives full curriculum access.</li>
            ...
            <li><strong>Direct and single-level:</strong> You earn on customers you personally refer. The program has no tiers, teams, group structures, or override commissions.</li>
            <li><strong>No rewards for sign-ups alone:</strong> Only completed program purchases generate commissions.</li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-2 text-textMuted">
            <li>Earning commissions through your own purchases, accounts connected to you, or circular referral arrangements.</li>
            ...
            <li>Cashback or rebate offers tied to your referral link.</li>
            <li>Bidding on &ldquo;ZetaGrow&rdquo; or related brand terms in paid search advertising without written permission.</li>
          </ul>
          <p>Accounts that do not follow these guidelines may lose referral privileges, and pending commissions may be withheld where misuse is involved.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-2 text-textMuted">
            <li>Let people know you earn a commission when they purchase through your link — a simple note such as &ldquo;affiliate link&rdquo; works well.</li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-2 text-textMuted">
            <li>ZetaGrow may review referral activity and promotional content from time to time.</li>
            <li>Commission rates, terms, or the program itself may change; material changes will be communicated in advance where practical.</li>
          </ul>
        </section>
