...
export const metadata: Metadata = {
  ...
  description:
    "How ZetaGrow calculates, verifies and pays referral commissions — genuine-purchase requirement, single-level structure, holding periods and tax compliance.",
};

const sections = [
  {
    h: "1. Purpose",
    p: "This policy explains how ZetaGrow may pay variable remuneration (referred to as a “commission” or “referral reward”) to eligible users who voluntarily share our courses. It exists so that every participant — and any observer — can see exactly when, why and how much is paid. ZetaGrow is an education platform: commissions are a marketing cost we choose to share for real sales of real courses, nothing more.",
  },
  {
    h: "2. Core Principles",
    list: [
  ...
  {
    h: "3. Qualifying Sale",
    p: "A “Qualifying Sale” means: (a) a person who did not previously hold a ZetaGrow account completes payment for a published course plan through your referral link; (b) the purchase is not self-referred or connected to you (same person, household, device cluster or payment instrument); and (c) the buyer demonstrates genuine course usage by completing at least one lesson inside their dashboard.",
  },
  {
    h: "4. Consumption Verification",
    p: "For every referred purchase, the platform records whether the buyer has begun actually using the course. The commission is flagged as awaiting consumption until this first verified usage event occurs. Only then does it enter the standard approval workflow. This protects the integrity of the program: rewards follow delivered education, not transactions alone. Usage records (lesson completion timestamps) form part of ZetaGrow’s audit trail.",
  },
  {
  ...
  },
  {
    ...
    list: [
      "Activated commissions enter a 30-day holding period from the sale date to cover chargebacks and payment disputes.",
      "After the holding period and administrative approval, commissions move to your wallet and become withdrawable per the platform’s withdrawal rules (minimum thresholds, KYC via PAN and bank verification).",
  ...
  },
  {
    ...
    list: [
      ...
      "Describing the referral program as an investment, ROI scheme, business opportunity or membership in a network.",
      "Spam, unsolicited bulk messaging, impersonation or fabricated claims about ZetaGrow.",
    ],
  },
  {
    h: "8. Reversals & Adjustments",
    p: "If a referred purchase is cancelled, disputed or determined fraudulent, the associated commission — at any stage (awaiting, held, approved or paid) — may be reversed or clawed back, including by adjustment against future commissions. ZetaGrow may update commission rates or this policy prospectively; material changes will be communicated where practical.",
  },
  {
    h: "9. Relationship to ZetaGrow",
    p: "Participants in the referral program act as independent promoters of our courses. Nothing in this policy creates employment, agency, partnership or joint venture. Participation is optional and separate from learning; you may use all purchased courses fully without ever referring anyone.",
  },
];
      ...
      <div className="prose prose-sm max-w-none text-textMuted space-y-8 text-sm leading-relaxed">
        ...
        <div className="pt-8 border-t border-borderSubtle">
          <p className="text-xs text-textMuted">
            ...
            <Link href="/affiliate-guidelines" className="text-brand-700 underline hover:text-brand-800">Referral Program Guidelines</Link> ·{" "}
